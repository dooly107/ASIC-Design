...
COMPONENT_FILES	:= flex_counter.sv acceptance_filter.sv AHB_Slave.sv arbitration.sv can_crc.sv can_register.sv Command_FIFO_storage.sv Control_Unit.sv flex_pts_sr.sv flex_stp_sr.sv rx_sr.sv Sensor_FIFO_storage.sv tx_sr.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= AHB2CAN_top.sv
